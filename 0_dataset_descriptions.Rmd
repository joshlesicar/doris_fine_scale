...
The kinship data set only included individuals identified as belonging to the same ancestral population (from structure analyses) and from the palmer archipelago.

```{r,echo = FALSE}
data_frame <- data.frame(
  Location = c("Palmer Archipelago"),
  N = c(113)
)
kable(data_frame, caption = "Table 4: Individuals included in the kinship data set.")
```